    ...
    <section id="calculator-container">
      ...
      <div id="calculator">
        ...
        <div id="calculator-buttons">
          <button type="button" onClick={handleClick} className="btn orange">AC</button>
          <button type="button" onClick={handleClick} className="btn orange">+/-</button>
          <button type="button" onClick={handleClick} className="btn orange">%</button>
          <button type="button" onClick={handleClick} className="btn green">÷</button>
          ...
          <button type="button" onClick={handleClick} className="btn green">x</button>
